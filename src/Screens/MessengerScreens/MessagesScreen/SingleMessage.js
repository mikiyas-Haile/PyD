...
import { Text, View, useColorScheme, ToastAndroid, StyleSheet, Image, Pressable, Dimensions, TouchableOpacity, Animated, Modal, TouchableWithoutFeedback } from 'react-native'
import * as Clipboard from 'expo-clipboard';
import AwesomeAlert from 'react-native-awesome-alerts';
import { MainLookup } from '../../../lookup/index';
...
export default function Message(props) {
    ...
    const Delete = () => {
        ...
        MainLookup(cb, {
            endpoint: `/api/delete-chat`, csrf: csrfToken, token: token, method: "POST", data: {
                id: chat.id
            }
        })
    }
